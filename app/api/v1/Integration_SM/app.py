...
async def consultar_persona(
    ...
    try:
        ...
        #     url_consult_persona, data=json.dumps(body), headers=headers, timeout=None
        # )
...
async def crear_persona(
    ...
    try:
        # response = await client.post(
        #     url_crear_persona, data=json.dumps(body), headers=headers, timeout=None
        # )
        response = await fetch_url(
            "POST",
            url_crear_persona,
...
async def crear_cotizacion(
    ...
    try:
        # response = await client.post(
        #     url_crear_poliza, data=json.dumps(body), headers=headers, timeout=None
        # )
        response = await fetch_url(
            "POST",
            url_crear_poliza,
...
async def consultar_poliza(
    ...
    try:
        # response = await client.post(
        #     url_consultar_poliza, data=json.dumps(body), headers=headers, timeout=None
        # )
        response = await fetch_url(
            "POST",
